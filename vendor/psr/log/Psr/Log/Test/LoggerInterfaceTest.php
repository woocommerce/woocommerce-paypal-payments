...
use WooCommerce\PayPalCommerce\Vendor\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('WooCommerce\PayPalCommerce\Vendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WooCommerce\PayPalCommerce\Vendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WooCommerce\PayPalCommerce\Vendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
