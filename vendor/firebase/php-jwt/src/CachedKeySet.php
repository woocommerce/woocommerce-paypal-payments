...
use WooCommerce\PayPalCommerce\Vendor\Psr\Cache\CacheItemInterface;
use WooCommerce\PayPalCommerce\Vendor\Psr\Cache\CacheItemPoolInterface;
use WooCommerce\PayPalCommerce\Vendor\Psr\Http\Client\ClientInterface;
use WooCommerce\PayPalCommerce\Vendor\Psr\Http\Message\RequestFactoryInterface;
...
class CachedKeySet implements ArrayAccess
{
    ...
    public function offsetGet($keyId): \Firebase\JWT\Key
    {
        ...
        return \Firebase\JWT\JWK::parseKey($this->keySet[$keyId], $this->defaultAlg);
    }
    /**
     * @param string $keyId
     * @return bool
