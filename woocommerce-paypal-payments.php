 ...
 * Version: 4.0.0-rc1+pcp-6058-critical-uncaught-error-call-to-a-member-function-get-base-country-on-null-when-upgrading-the-plugin.65f6f29
 * Author:      PayPal
    ...
    add_action('plugins_loaded', function () {
        ...
        add_action('init', function () {
            ...
            if ($installed_plugin_version !== $current_plugin_version) {
                ...
                add_action('woocommerce_init', function () use ($installed_plugin_version) {
                    /**
