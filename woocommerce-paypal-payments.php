 ...
 * Version: 3.3.2-alpha+pcp-5677-remove-dhii-versions.6ec0824
 * Author:      PayPal
...
(function () {
    ...
    add_action('plugins_loaded', function () {
        ...
        add_action('init', function () {
            $current_plugin_version = (string) \WooCommerce\PayPalCommerce\PPCP::container()->get('ppcp.plugin-version');
