...
class PaymentSource
{
     ...
     */
    public function __construct(string $given_name, string $surname, string $email, string $birth_date, string $national_number, string $phone_country_code, string $address_line_1, string $admin_area_2, string $postal_code, string $country_code, string $locale, string $brand_name, string $logo_url, array $customer_service_instructions)
    {
    ...
    {
        return array('name' => array('given_name' => $this->given_name(), 'surname' => $this->surname()), 'email' => $this->email(), 'birth_date' => $this->birth_date(), 'phone' => array('national_number' => $this->national_number(), 'country_code' => $this->phone_country_code()), 'billing_address' => array('address_line_1' => $this->address_line_1(), 'admin_area_2' => $this->admin_area_2(), 'postal_code' => $this->postal_code(), 'country_code' => $this->country_code()), 'experience_context' => array('locale' => $this->locale(), 'brand_name' => $this->brand_name(), 'logo_url' => $this->logo_url(), 'customer_service_instructions' => $this->customer_service_instructions()));
    }
}
