...
return array(
	'ppcp-local-apms.get_module_asset_url'      => static function ( ContainerInterface $container ): callable {
		...
		return static function ( string $asset_name ) use ( $getter ): string {
			return ( $getter )( 'ppcp-local-alternative-payment-methods', $asset_name );
		};
	},
	...
	'ppcp-local-apms.pwc.payment-method'        => static function ( ContainerInterface $container ): PWCPaymentMethod {
		return new PWCPaymentMethod(
			$container->get( 'ppcp-local-apms.get_module_asset_url' ),
