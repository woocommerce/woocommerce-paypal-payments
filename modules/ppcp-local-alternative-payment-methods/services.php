...
return array('ppcp-local-apms.url' => static function (ContainerInterface $container): string {
    ...
    return new \WooCommerce\PayPalCommerce\LocalAlternativePaymentMethods\PWCPaymentMethod($container->get('ppcp-local-apms.url'), $container->get('ppcp.asset-version'), $container->get('ppcp-local-apms.pwc.wc-gateway'));
