...
class SimulateCartEndpoint extends \WooCommerce\PayPalCommerce\Button\Endpoint\AbstractCartEndpoint
{
    ...
    public function __construct(SmartButtonInterface $smart_button, \WooCommerce\PayPalCommerce\Button\Endpoint\RequestData $request_data, CartProductsHelper $cart_products, ProductPriceCalculator $price_calculator, IsolatedCartSimulator $cart_simulator, LoggerInterface $logger)
    {
