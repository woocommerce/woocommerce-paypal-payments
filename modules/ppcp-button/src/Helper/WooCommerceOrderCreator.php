...
class WooCommerceOrderCreator
{
    ...
    public function __construct(FundingSourceRenderer $funding_source_renderer, SessionHandler $session_handler, SubscriptionHelper $subscription_helper, CartDataFactory $cart_data_factory, ShippingFactory $shipping_factory, PayerFactory $payer_factory, ShippingOptionFactory $shipping_option_factory)
    {
    ...
    public function create_from_paypal_order(Order $order, $cart, ?array $paypal_data = null): WC_Order
    {
        ...
        try {
            ...
            $shipping_option = $this->resolve_shipping_option($shipping, $cart_data->needs_shipping(), $cart instanceof WC_Cart);
