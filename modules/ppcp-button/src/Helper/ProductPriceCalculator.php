...
class ProductPriceCalculator
{
    ...
    public function calculate_total(array $products): float
    {
        ...
        foreach ($products as $product_data) {
            ...
            $total += (float) wc_get_price_including_tax($product, array('qty' => $quantity));
        }
        return $total;
    }
    /**
    ...
    public function needs_cart_simulation(array $products): bool
    {
        ...
        return (bool) apply_filters('woocommerce_paypal_payments_simulate_cart_needs_full_simulation', \false, $products);
    }
