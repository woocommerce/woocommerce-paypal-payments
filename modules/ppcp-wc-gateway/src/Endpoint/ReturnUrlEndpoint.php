...
class ReturnUrlEndpoint
{
     ...
     */
    public function __construct(PayPalGateway $gateway, OrderEndpoint $order_endpoint, SessionHandler $session_handler, LoggerInterface $logger, OrderStatusHelper $order_status_helper)
    {
