...
return array('compat.ppec.mock-gateway' => static function ($container) {
    ...
    return new PayPalSettingsExporter($container->get('compat.blueprint.connection_data_sanitizer'), \false);
    ...
    return new PayPalSettingsExporter($container->get('compat.blueprint.connection_data_sanitizer'), \true);
    ...
    return new PayPalBlueprintBootstrap($container->get('compat.blueprint.paypal_settings_exporter'), $container->get('compat.blueprint.paypal_settings_exporter_with_connection'), $container->get('compat.blueprint.paypal_settings_importer'));
});
