...
class WebhookRegistrar
{
    ...
    private function do_register(): bool
    {
        ...
        error_log(
            ...
            sprintf('[ngrok-diag] IncomingWebhookEndpoint::url()=%s rest_url(paypal/v1/incoming)=%s getenv(NGROK_HOST)=%s home_url()=%s', $this->incoming_webhook_endpoint->url(), rest_url('paypal/v1/incoming'), var_export(getenv('NGROK_HOST'), \true), home_url())
        );
