 ...
 */
class CheckoutPaymentApprovalReversed implements \WooCommerce\PayPalCommerce\Webhooks\Handler\RequestHandler
{
    ...
    {
        return array('CHECKOUT.PAYMENT-APPROVAL.REVERSED');
    }
    /**
