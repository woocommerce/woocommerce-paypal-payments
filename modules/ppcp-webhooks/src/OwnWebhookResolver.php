...
class OwnWebhookResolver
{
    ...
    public function __construct(\WooCommerce\PayPalCommerce\Webhooks\IncomingWebhookEndpoint $incoming_webhook_endpoint)
    {
    ...
    {
        return (string) (((array) get_option(\WooCommerce\PayPalCommerce\Webhooks\WebhookRegistrar::KEY, array()))['id'] ?? '');
    }
}
