...
return array('sdk-v6.asset-getter' => static function (ContainerInterface $container): AssetGetter {
    ...
    return new AddPaymentMethodManager($container->get('sdk-v6.asset-getter'), $container->get('ppcp.asset-version'), $container->get('settings.environment'), $container->get('button.helper.context'), $container->get('settings.settings-provider')->save_paypal_and_venmo());
