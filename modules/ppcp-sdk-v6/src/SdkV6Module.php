...
class SdkV6Module implements ServiceModule, ExtendingModule, ExecutableModule
{
    ...
    public function run(ContainerInterface $c): bool
    {
        ...
        add_action('wc_ajax_' . CartQuoteEndpoint::ENDPOINT, static function () use ($c) {
        ...
        add_action('woocommerce_paypal_payments_authenticated_merchant', static function () use ($c) {
    ...
    private function prices_a_merchant_presented_payment(): bool
    {
        ...
        return in_array($action, array(CartQuoteEndpoint::ENDPOINT, ChangeCartEndpoint::ENDPOINT, CreateOrderEndpoint::ENDPOINT, ApproveOrderEndpoint::ENDPOINT), \true);
    }
    /**
...
document.querySelector("#payment").before(document.querySelector(".ppcp-messages"))
    ...
    private function register_render_hooks(SdkV6Manager $manager): void
    {
        ...
        if ($places['cart']) {
             ...
             * Shared with the v5 SmartButton so a single override relocates both stacks.
             */
            $hook = (string) apply_filters('woocommerce_paypal_payments_proceed_to_checkout_button_renderer_hook', 'woocommerce_proceed_to_checkout');
        ...
        if ($places['mini-cart']) {
             ...
             * Shared with the v5 SmartButton so a single override relocates both stacks.
             */
            $hook = (string) apply_filters('woocommerce_paypal_payments_mini_cart_button_renderer_hook', 'woocommerce_widget_shopping_cart_after_buttons');
