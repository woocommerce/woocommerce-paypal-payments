...
class AddPaymentMethodManager
{
    ...
    public function __construct(AssetGetter $asset_getter, string $version, Environment $environment, Context $context, bool $vaulting_enabled)
    {
    ...
    public function enqueue(): void
    {
        ...
        wp_add_inline_style('wc-ppcp-sdk-v6-add-payment-method', '#place_order.ppcp-hidden{display:none !important;}');
    }
    /**
    ...
    {
        return is_user_logged_in() && $this->vaulting_enabled && $this->context->is_add_payment_method_page();
    }
    /**
