...
class MessagesEligibility
{
    ...
    public function __construct(SettingsProvider $settings_provider, SettingsStatus $settings_status, MessagesApply $messages_apply, FreeTrialSubscriptionHelper $free_trial_helper)
    {
    ...
    public function is_hidden(string $context): bool
    {
        if ('product' === $context) {
             ...
             * Shared with the v5 SmartButton.
             */
            return (bool) apply_filters('woocommerce_paypal_payments_product_buttons_paylater_disabled', \false, $this->product_filter_context_data());
        }
        /**
         * Allows to decide if Pay Later should be disabled on a given context.
         * Shared with the v5 SmartButton.
         */
        return (bool) apply_filters('woocommerce_paypal_payments_buttons_paylater_disabled', \false, $context);
    }
    /**
