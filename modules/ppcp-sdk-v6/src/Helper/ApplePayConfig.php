...
class ApplePayConfig extends \WooCommerce\PayPalCommerce\SdkV6\Helper\WalletConfig
{
    /**
    ...
    public function styles(string $context): array
    {
        ...
        return array('color' => PropertiesDictionary::map_color($styling->color), 'type' => PropertiesDictionary::map_type($styling->label), 'language' => PropertiesDictionary::map_language($this->settings_provider->applepay_button_language()), 'borderRadius' => self::RADIUS_MAP[$styling->shape] ?? self::DEFAULT_RADIUS);
    }
    /**
