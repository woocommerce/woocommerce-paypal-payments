...
class ButtonStyleMapper
{
     ...
     */
    private const COLOR_MAP = array('gold' => 'paypal-gold', 'blue' => 'paypal-blue', 'white' => 'paypal-white', 'black' => 'paypal-black', 'silver' => 'paypal-white');
    /**
    ...
    public function styles_for_context(string $context): array
    {
        ...
        return array('colorClass' => self::COLOR_MAP[$color] ?? 'paypal-gold', 'borderRadius' => self::SHAPE_MAP[$shape] ?? '24px');
    }
}
