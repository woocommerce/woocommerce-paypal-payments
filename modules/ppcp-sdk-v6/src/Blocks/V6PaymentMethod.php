...
class V6PaymentMethod extends AbstractPaymentMethodType
{
    ...
    public function __construct(SdkV6Manager $manager, AssetGetter $asset_getter, string $version, PayPalGateway $gateway)
    {
    ...
    {
        return array_merge($this->manager->script_data(), array('id' => PayPalGateway::ID, 'title' => $this->gateway->title, 'description' => $this->gateway->get_description()));
    }
}
