...
return array(
    ...
    'fraud-protection.recaptcha' => static function (ContainerInterface $container): Recaptcha {
        return new Recaptcha($container->get('fraud-protection.recaptcha.integration'), $container->get('fraud-protection.recaptcha.payment-methods'), $container->get('fraud-protection.asset_getter'), $container->get('ppcp.asset-version'), $container->get('woocommerce.logger.woocommerce'), $container->get('fraud-protection.recaptcha.rejection-counter'), $container->get('wcgateway.settings.status'), $container->get('fraud-protection.recaptcha.rejection-logger'));
    },
    ...
    'fraud-protection.recaptcha.rejection-logger' => static function (): LoggerInterface {
        ...
        return new WooCommerceLogger(wc_get_logger(), Recaptcha::REJECTION_LOGGER_SOURCE);
    },
