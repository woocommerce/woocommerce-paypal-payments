...
class RecaptchaIntegration extends WC_Integration
{
    ...
    public function __construct()
    {
        ...
        $this->method_description = sprintf('Card-testing attacks have become increasingly common across ecommerce platforms. Native bot protection has been implemented directly within WooCommerce PayPal Payments, helping safeguard your checkout without adding friction for real customers.<br>We recommend enabling this feature immediately to strengthen security and reduce risk.<br>PayPal Payments reCAPTCHA blocks automated card-testing attacks on PayPal payment endpoints. <strong>Both reCAPTCHA v3 and v2 keys must be configured</strong> for protection to activate. %s', '<a href="https://woocommerce.com/document/woocommerce-paypal-payments/fraud-and-disputes/" target="_blank">Learn more</a>');
