...
class RecaptchaIntegration extends WC_Integration {
	...
	public function __construct() {
		...
		$this->method_description = sprintf(
			'<h3>Protect your store from card-testing fraud and potential fines.</h3>Protect your store from card-testing fraud and potential fines. Card networks like Visa, Mastercard, American Express and Discover are actively penalizing merchants without fraud prevention controls—consequences include per-transaction fines, processing restrictions, and account termination.<br>Enable reCAPTCHA protection below to block automated card-testing attacks without adding friction for real customers. Both reCAPTCHA v3 and v2 keys must be configured for protection to activate. %s',
			'<a href="https://woocommerce.com/document/woocommerce-paypal-payments/fraud-and-disputes/#section-4" target="_blank">Learn more</a>'
		);
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'site_key_v3'     => array(
				...
				'type'        => 'text',
				'desc_tip'    => true,
				'description' => 'Your reCAPTCHA v3 site key',
			),
			'secret_key_v3'   => array(
				'title'       => 'v3 Secret Key',
				'type'        => 'password',
				'desc_tip'    => true,
				'description' => 'Your reCAPTCHA v3 secret key',
			),
			...
			'site_key_v2'     => array(
				...
				'type'        => 'text',
				'desc_tip'    => true,
				'description' => 'Your reCAPTCHA v2 (checkbox) site key',
			),
			'secret_key_v2'   => array(
				'title'       => 'v2 Secret Key',
				'type'        => 'password',
				'desc_tip'    => true,
				'description' => 'Your reCAPTCHA v2 secret key',
			),
			'v2_theme'        => array(
				'title'       => 'v2 Theme',
				'type'        => 'select',
				...
				'desc_tip'    => true,
				'description' => 'Color theme for the v2 checkbox',
			),
			...
			'guest_only'      => array(
				...
				'type'        => 'checkbox',
				'label'       => 'Only verify for non-logged-in users',
				'default'     => 'yes',
				'description' =>
			...
			'show_metabox'    => array(
				'title'       => 'Order Metabox',
				'type'        => 'checkbox',
				'label'       => 'Show reCAPTCHA status metabox on order pages',
				'default'     => 'no',
				'description' =>
