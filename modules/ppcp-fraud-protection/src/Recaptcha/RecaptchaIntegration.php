...
class RecaptchaIntegration extends WC_Integration {
	...
	public function __construct() {
		...
		$this->method_description = sprintf(
			'Protect your store from card-testing fraud and potential fines. Card networks are actively penalizing merchants without fraud prevention controls—consequences include per-transaction fines, processing restrictions, and account termination.<br>Enable reCAPTCHA protection below to help block automated card-testing attacks without adding friction for real customers. Both reCAPTCHA v3 and v2 keys must be configured for protection to activate. %s',
