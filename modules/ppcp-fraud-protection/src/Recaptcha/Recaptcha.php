...
class Recaptcha
{
     ...
     */
    public function __construct(\WooCommerce\PayPalCommerce\FraudProtection\Recaptcha\RecaptchaIntegration $integration, array $payment_methods, string $module_url, string $asset_version, LoggerInterface $logger, PersistentCounter $rejection_counter)
    {
