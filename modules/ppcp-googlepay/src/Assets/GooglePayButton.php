...
class GooglePayButton implements ButtonInterface
{
     ...
     */
    public function __construct(AssetGetter $asset_getter, string $sdk_url, string $version, SubscriptionHelper $subscription_helper, SettingsProvider $settings, Environment $environment, SettingsStatus $settings_status, Context $context)
    {
    ...
    public function render(): bool
    {
        ...
        // todo - why is this hardcoded as true?
