...
class VaultComponentModule implements ServiceModule, ExecutableModule
{
    ...
    public function run(ContainerInterface $c): bool
    {
        ...
        add_filter('woocommerce_payment_gateway_get_saved_payment_method_option_html', static function (string $html, WC_Payment_Token $token, $gateway) use (&$vault_injected, $eligibility_check, $c): string {
