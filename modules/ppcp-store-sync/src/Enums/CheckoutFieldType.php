...
class CheckoutFieldType
{
    ...
    {
        return array(self::AGE_VERIFICATION_18_PLUS, self::AGE_VERIFICATION_21_PLUS, self::GIFT_RECIPIENT_EMAIL, self::GIFT_RECIPIENT_NAME, self::GIFT_MESSAGE, self::DELIVERY_INSTRUCTIONS, self::DELIVERY_DATE_PREFERENCE, self::ALLERGY_INFORMATION, self::CUSTOM_ENGRAVING_TEXT, self::CUSTOM_SIZING_INFO, self::TERMS_ACCEPTANCE, self::PRIVACY_CONSENT);
    }
