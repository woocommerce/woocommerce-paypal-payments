...
class DataIssue
{
    ...
    {
        return array(self::MISSING_CHECKOUT_FIELDS, self::INVALID_EMAIL_FORMAT, self::MISSING_PAYMENT_METHOD, self::MISSING_POLICY_ACCEPTANCE, self::REQUIRED_FIELD_MISSING, self::INVALID_PHONE_FORMAT, self::FIELD_VALUE_TOO_LONG, self::FIELD_VALUE_TOO_SHORT, self::INVALID_DATE_FORMAT, self::FUTURE_DATE_NOT_ALLOWED, self::INVALID_CUSTOMER_DATA, self::ITEM_NOT_FOUND, self::INVALID_ITEM_DATA, self::ITEM_ATTRIBUTE_MISMATCH);
    }
