...
class ShippingIssue
{
    ...
    {
        return array(self::SHIPPING_ADDRESS_INVALID, self::INTERNATIONAL_SHIPPING_RESTRICTED, self::MISSING_SHIPPING_ADDRESS, self::SHIPPING_TO_PO_BOX_NOT_ALLOWED, self::NO_SHIPPING_OPTIONS, self::REGION_RESTRICTED, self::OVERSIZED_ITEM_SHIPPING, self::HAZARDOUS_MATERIAL_SHIPPING, self::SHIPPING_ZONE_NOT_COVERED, self::MISSING_COORDINATES_FOR_ENHANCED_DELIVERY);
    }
