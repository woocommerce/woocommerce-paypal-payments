...
class BusinessRuleIssue
{
    ...
    {
        return array(self::MINIMUM_ORDER_NOT_MET, self::AGE_RESTRICTED_PRODUCT, self::PURCHASE_LIMIT_EXCEEDED, self::MINIMUM_QUANTITY_NOT_MET, self::MAXIMUM_QUANTITY_EXCEEDED, self::CART_LIMIT_EXCEEDED, self::CUSTOMER_ACCOUNT_SUSPENDED, self::BULK_ORDER_APPROVAL_REQUIRED, self::STORE_TEMPORARILY_CLOSED, self::LOYALTY_PROGRAM_VALIDATION_FAILED, self::BUSINESS_HOURS_RESTRICTION, self::PRODUCT_ARCHIVED, self::SUBSCRIPTION_PRODUCT_ERROR);
    }
