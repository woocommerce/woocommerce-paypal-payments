...
class PricingIssue
{
    ...
    {
        return array(self::PRICE_MISMATCH, self::DISCOUNT_EXPIRED, self::CURRENCY_MISMATCH, self::DISCOUNT_USAGE_LIMIT_EXCEEDED, self::DISCOUNT_CUSTOMER_INELIGIBLE, self::DISCOUNT_MINIMUM_NOT_MET, self::TAX_CALCULATION_FAILED, self::CURRENCY_NOT_SUPPORTED, self::PROMOTIONAL_CONFLICT);
    }
