...
class ResolutionOption
{
    ...
    {
        $data = array('action' => $this->action, 'label' => $this->label);
        if ($this->url) {
    ...
    {
        return new self(ResolutionAction::MODIFY_CART, $label, '', $metadata);
    }
    /**
    ...
    {
        return new self(ResolutionAction::SUGGEST_ALTERNATIVE, $label, '', $metadata);
    }
    /**
    ...
    {
        return new self(ResolutionAction::WAIT_FOR_RESTOCK, $label, '', $metadata);
    }
    /**
    ...
    public static function use_different_currency(string $label, string $expected_currency, array $metadata = array()): self
    {
        ...
        return new self(ResolutionAction::USE_DIFFERENT_CURRENCY, $label, '', $metadata);
    }
    /**
    ...
    {
        return new self(ResolutionAction::ACCEPT_NEW_PRICE, $label, '', $metadata);
    }
    /**
    ...
    {
        return new self(ResolutionAction::REDIRECT_TO_MERCHANT, $label, $url, $metadata);
    }
    /**
    ...
    {
        return new self(ResolutionAction::UPDATE_SHIPPING_METHOD, $label, '', $metadata);
    }
    /**
    ...
    {
        return new self(ResolutionAction::CONTACT_SUPPORT, $label, '', $metadata);
    }
    /**
    ...
    {
        $metadata['priority'] = $priority;
        return new self(ResolutionAction::REMOVE_COUPON, $label, '', $metadata);
    }
    /**
    ...
    {
        $metadata['priority'] = $priority;
        return new self(ResolutionAction::APPLY_DIFFERENT_COUPON, $label, '', $metadata);
    }
    /**
    ...
    {
        $metadata['priority'] = $priority;
        return new self(ResolutionAction::KEEP_CURRENT_COUPON, $label, '', $metadata);
    }
}
