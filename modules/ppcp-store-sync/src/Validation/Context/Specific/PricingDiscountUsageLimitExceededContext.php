...
class PricingDiscountUsageLimitExceededContext extends PricingErrorContext {
	protected const SPECIFIC_ISSUE = ContextPricingIssue::DISCOUNT_USAGE_LIMIT_EXCEEDED;
}
