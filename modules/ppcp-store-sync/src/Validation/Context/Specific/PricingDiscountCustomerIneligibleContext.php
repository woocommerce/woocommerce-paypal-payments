...
class PricingDiscountCustomerIneligibleContext extends PricingErrorContext {
	protected const SPECIFIC_ISSUE = ContextPricingIssue::DISCOUNT_CUSTOMER_INELIGIBLE;
}
