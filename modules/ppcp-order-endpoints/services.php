...
return array(
    ...
    'order-endpoints.current-user-must-register' => static function (ContainerInterface $container): bool {
        return !$container->get('order-endpoints.is-logged-in') && $container->get('order-endpoints.registration-required');
    },
