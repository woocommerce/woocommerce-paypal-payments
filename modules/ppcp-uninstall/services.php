...
return array(
	'uninstall.ppcp-all-option-names'           => static function ( ContainerInterface $container ): array {
		$own_option_keys = array(
	...
	'uninstall.clear-db'                        => static function ( ContainerInterface $container ): ClearDatabase {
		return new ClearDatabase(
			$container->get( 'uninstall.ppcp-all-option-names' ),
			$container->get( 'uninstall.ppcp-all-scheduled-action-names' ),
		);
	},
);
