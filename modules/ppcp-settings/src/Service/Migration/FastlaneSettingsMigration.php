...
class FastlaneSettingsMigration implements SettingsMigrationInterface {
	...
	protected function map(): array {
		return array(
			'axo_name_on_card'                   => 'name_on_card',
			'axo_style_root_bg_color'            => 'style_root_bg_color',
			'axo_style_root_error_color'         => 'style_root_error_color',
			'axo_style_root_font_family'         => 'style_root_font_family',
			'axo_style_root_text_color_base'     => 'style_root_text_color_base',
			'axo_style_root_font_size_base'      => 'style_root_font_size_base',
			'axo_style_root_padding'             => 'style_root_padding',
			'axo_style_root_primary_color'       => 'style_root_primary_color',
			'axo_style_input_bg_color'           => 'style_input_bg_color',
			'axo_style_input_border_radius'      => 'style_input_border_radius',
			'axo_style_input_border_color'       => 'style_input_border_color',
			'axo_style_input_border_width'       => 'style_input_border_width',
			'axo_style_input_text_color_base'    => 'style_input_text_color_base',
			'axo_style_input_focus_border_color' => 'style_input_focus_border_color',
		);
	}
}
