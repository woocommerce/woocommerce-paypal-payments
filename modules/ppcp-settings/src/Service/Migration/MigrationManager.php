...
class MigrationManager implements \WooCommerce\PayPalCommerce\Settings\Service\Migration\SettingsMigrationInterface
{
    ...
    public function migrate(): void
    {
        try {
            ...
            $this->logger->warning('Settings migration failed during transition to new UI', array('error_message' => $error->getMessage(), 'error_code' => $error->getCode(), 'trace' => $error->getTraceAsString()));
        }
    }
}
