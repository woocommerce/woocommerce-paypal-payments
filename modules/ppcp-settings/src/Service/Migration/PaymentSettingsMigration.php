...
class PaymentSettingsMigration implements \WooCommerce\PayPalCommerce\Settings\Service\Migration\SettingsMigrationInterface
{
    ...
    public function migrate(): void
    {
        ...
        $pay_later_enabled = $this->settings['pay_later_button_enabled'] ?? \true;
        if ($pay_later_enabled) {
            $this->payment_settings->toggle_method_state('pay-later', \true);
        }
    ...
    {
        return array('dcc_enabled' => CreditCardGateway::ID, 'axo_enabled' => AxoGateway::ID, 'applepay_button_enabled' => ApplePayGateway::ID, 'googlepay_button_enabled' => GooglePayGateway::ID);
    }
    /**
