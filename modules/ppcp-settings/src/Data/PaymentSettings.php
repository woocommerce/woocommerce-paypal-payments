...
class PaymentSettings extends \WooCommerce\PayPalCommerce\Settings\Data\AbstractDataModel
{
    ...
    {
        return array('paypal_show_logo' => \false, 'cardholder_name' => \false, 'fastlane_display_watermark' => \false, 'venmo_enabled' => \false, 'paylater_enabled' => \false, 'applepay_validated' => \false, 'applepay_checkout_data_mode' => 'use_wc');
    }
    /**
