...
class FastlaneSettings extends AbstractDataModel {
	...
	protected function get_defaults(): array {
		return array(
			'name_on_card'                   => '',
			'style_root_bg_color'            => '',
			'style_root_error_color'         => '',
			'style_root_font_family'         => '',
			'style_root_text_color_base'     => '',
			'style_root_font_size_base'      => '',
			'style_root_padding'             => '',
			'style_root_primary_color'       => '',
			'style_input_bg_color'           => '',
			'style_input_border_radius'      => '',
			'style_input_border_color'       => '',
			'style_input_border_width'       => '',
			'style_input_text_color_base'    => '',
			'style_input_focus_border_color' => '',
		);
	}
	...
	public function get_root_styles(): array {
		return array(
			'backgroundColor' => (string) $this->data['style_root_bg_color'],
			'errorColor'      => (string) $this->data['style_root_error_color'],
			'fontFamily'      => (string) $this->data['style_root_font_family'],
			'textColorBase'   => (string) $this->data['style_root_text_color_base'],
			'fontSizeBase'    => (string) $this->data['style_root_font_size_base'],
			'padding'         => (string) $this->data['style_root_padding'],
			'primaryColor'    => (string) $this->data['style_root_primary_color'],
		);
	}
	...
	public function get_input_styles(): array {
		return array(
			'backgroundColor'  => (string) $this->data['style_input_bg_color'],
			'borderRadius'     => (string) $this->data['style_input_border_radius'],
			'borderColor'      => (string) $this->data['style_input_border_color'],
			'borderWidth'      => (string) $this->data['style_input_border_width'],
			'textColorBase'    => (string) $this->data['style_input_text_color_base'],
			'focusBorderColor' => (string) $this->data['style_input_focus_border_color'],
		);
	}
