...
class WebhookSettingsEndpoint extends \WooCommerce\PayPalCommerce\Settings\Endpoint\RestEndpoint
{
     ...
     *                                                 app.
     */
    public function __construct(WebhookEndpoint $webhook_endpoint, WebhookRegistrar $webhook_registrar, WebhookSimulation $webhook_simulation, OwnWebhookResolver $own_webhook_resolver)
    {
