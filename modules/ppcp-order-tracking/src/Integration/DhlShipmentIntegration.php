...
class DhlShipmentIntegration implements Integration
{
    ...
    {
        add_action('pr_save_dhl_label_tracking', function (int $order_id, array $tracking_details) {
            try {
                ...
                $ppcp_shipment = $this->shipment_factory->create_shipment($order_id, $capture_id, $tracking_number, 'SHIPPED', 'DE_DHL', $carrier, array());
