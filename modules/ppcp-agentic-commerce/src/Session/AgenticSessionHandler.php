...
class AgenticSessionHandler
{
     ...
     */
    private \WooCommerce\PayPalCommerce\AgenticCommerce\Session\AgenticWcSession $session;
    /**
     * Constructor.
     */
    public function __construct()
    {
        ...
        $this->session = new \WooCommerce\PayPalCommerce\AgenticCommerce\Session\AgenticWcSession();
        $this->session->init();
    }
    /**
