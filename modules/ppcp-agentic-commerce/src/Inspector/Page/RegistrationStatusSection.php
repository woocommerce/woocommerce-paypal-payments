...
class RegistrationStatusSection
{
    use \WooCommerce\PayPalCommerce\AgenticCommerce\Inspector\Page\StatusTableRenderer;
    ...
    public function render(): void
    {
		...
		<div class="wrap">
			<h2><?php 
        esc_html_e('PayPal Agentic Commerce', 'woocommerce-paypal-payments');
        ?></h2>
    ...
    private function render_notices(): void
    {
        ...
        $messages = array('registered' => __('Successfully registered with PayPal Agentic Commerce.', 'woocommerce-paypal-payments'), 'unregistered' => __('Successfully unregistered from PayPal Agentic Commerce.', 'woocommerce-paypal-payments'), 'error' => __('Failed to update registration status. Please try again.', 'woocommerce-paypal-payments'));
