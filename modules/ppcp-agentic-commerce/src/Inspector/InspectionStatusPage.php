...
class InspectionStatusPage
{
    private \WooCommerce\PayPalCommerce\AgenticCommerce\Inspector\InspectionFormHandler $form_handler;
    private RegistrationStatusSection $registration_section;
    private CartSessionSection $session_section;
    public function __construct(\WooCommerce\PayPalCommerce\AgenticCommerce\Inspector\InspectionFormHandler $form_handler, RegistrationStatusSection $registration_section, CartSessionSection $session_section)
    {
