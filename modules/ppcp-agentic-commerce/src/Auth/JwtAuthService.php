...
class JwtAuthService
{
    ...
    protected \WooCommerce\PayPalCommerce\AgenticCommerce\Auth\PayPalJwkProvider $jwk_provider;
    protected MerchantMetadataProvider $metadata_provider;
    public function __construct(\WooCommerce\PayPalCommerce\AgenticCommerce\Auth\PayPalJwkProvider $jwk_provider, MerchantMetadataProvider $metadata_provider)
    {
