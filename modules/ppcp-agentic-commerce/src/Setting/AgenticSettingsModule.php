...
class AgenticSettingsModule extends ExtensionSettingsModule
{
    ...
    public function __construct(string $absolute_plugin_path, string $plugin_main_file, ExtensionRestEndpoint $settings_endpoint, RegistrationEligibility $eligibility_check, AssetGetter $asset_getter)
    {
