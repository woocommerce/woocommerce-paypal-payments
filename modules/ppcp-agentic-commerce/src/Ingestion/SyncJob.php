...
class SyncJob
{
     ...
     */
    public function __construct(string $api_endpoint, string $merchant_store_url, array $product_ids, LoggerInterface $logger)
    {
    ...
    public function execute(): void
    {
        ...
        $api_products = new \WooCommerce\PayPalCommerce\AgenticCommerce\Ingestion\ProductsPayload($this->merchant_store_url, $this->product_ids);
