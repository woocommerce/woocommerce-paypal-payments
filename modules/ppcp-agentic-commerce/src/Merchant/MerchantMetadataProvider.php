...
class MerchantMetadataProvider
{
     ...
     */
    public function get_metadata(): \WooCommerce\PayPalCommerce\AgenticCommerce\Merchant\MerchantMetadata
    {
        ...
        return new \WooCommerce\PayPalCommerce\AgenticCommerce\Merchant\MerchantMetadata(get_bloginfo('name'), $this->get_canonical_store_url(), $this->wc->countries->get_base_country(), get_woocommerce_currency(), $merchant_id, $this->get_canonical_store_url(), $merchant->merchant_country);
    }
    /**
