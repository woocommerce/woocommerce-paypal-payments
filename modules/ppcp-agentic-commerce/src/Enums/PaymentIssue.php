...
class PaymentIssue
{
    ...
    {
        return array(self::PAYMENT_DECLINED, self::PAYMENT_AMOUNT_TOO_SMALL, self::PAYMENT_METHOD_NOT_ACCEPTED, self::CURRENCY_CONVERSION_FAILED, self::PAYMENT_PROCESSOR_UNAVAILABLE, self::MERCHANT_ACCOUNT_ISSUE, self::PAYMENT_INSUFFICIENT_FUNDS, self::PAYMENT_EXPIRED, self::PAYMENT_FRAUD_DETECTED);
    }
