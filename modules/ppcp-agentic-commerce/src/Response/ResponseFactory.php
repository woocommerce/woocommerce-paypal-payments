...
class ResponseFactory
{
     ...
     */
    public function new_cart(PayPalCart $cart, string $cart_id, string $token): \WooCommerce\PayPalCommerce\AgenticCommerce\Response\NewCartResponse
    {
        $wc_cart = $this->build_wc_cart_or_null($cart);
        $applied_coupons = $this->build_applied_coupons($cart);
        return new \WooCommerce\PayPalCommerce\AgenticCommerce\Response\NewCartResponse($cart, $cart_id, $token, $applied_coupons, $wc_cart);
    }
    /**
     ...
     */
    public function from_order(WC_Order $order, PayPalCart $cart, string $cart_id): \WooCommerce\PayPalCommerce\AgenticCommerce\Response\PaidCartResponse
    {
        $wc_cart = $this->build_wc_cart_or_null($cart);
        $applied_coupons = $this->build_applied_coupons($cart);
        return new \WooCommerce\PayPalCommerce\AgenticCommerce\Response\PaidCartResponse($cart, $cart_id, $order, $applied_coupons, $wc_cart);
    }
    /**
     ...
     */
    public function from_cart(PayPalCart $cart, string $cart_id): \WooCommerce\PayPalCommerce\AgenticCommerce\Response\CartResponse
    {
        $wc_cart = $this->build_wc_cart_or_null($cart);
        $applied_coupons = $this->build_applied_coupons($cart);
        return new \WooCommerce\PayPalCommerce\AgenticCommerce\Response\CartResponse($cart, $applied_coupons, $cart_id, $wc_cart);
    }
    /**
