...
class ApiModule implements ServiceModule, FactoryModule, ExecutableModule
{
    ...
    public function run(ContainerInterface $c): bool
    {
         ...
         */
        add_action('woocommerce_paypal_payments_gateway_migrate_on_update', static function (): void {
         ...
         */
        add_action('woocommerce_paypal_payments_paypal_order_created', static function (Order $order) use ($c) {
         ...
         */
        add_filter('ppcp_retry_request_args', static function (array $args) use ($c): array {
