...
class PayPalBearerFactory
{
    ...
    public function __construct(ConnectionState $connection_state, TokenRateLimiter $rate_limiter, LoggerInterface $logger)
    {
     ...
     */
    public function create(string $host, string $client_id, string $client_secret, ?bool $is_connected = null, ?Cache $cache = null, ?SettingsProvider $settings = null): Bearer
    {
