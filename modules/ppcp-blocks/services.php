...
return array(
	...
	'blocks.product-messaging-renderer'      => static function ( ContainerInterface $container ): ProductPayLaterMessagesRenderer {
		...
		return new ProductPayLaterMessagesRenderer(
			array(
				'layout'     => $product->layout,
				'position'   => $product->logo_position,
				'logo'       => $product->logo_type,
				'text_size'  => $product->text_size,
				'color'      => $product->text_color,
				'flex_color' => $product->flex_color,
				'flex_ratio' => $product->flex_ratio,
			)
		);
	},
	...
	'blocks.product-hooked-blocks-registrar' => static function ( ContainerInterface $container ): HookedBlocksRegistrar {
		...
		$insertions = array(
			ProductBlocks::BUTTONS_BLOCK => array(
				'anchor'   => $add_to_cart_anchors,
				'position' => 'after',
				'enabled'  => static function () use ( $settings_status ): bool {
					return ProductBlocks::is_buttons_enabled( $settings_status );
				},
			),
		);
