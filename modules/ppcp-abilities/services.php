...
return array(
    'abilities.registrar' => static function (ContainerInterface $container): \WooCommerce\PayPalCommerce\Abilities\AbilitiesRegistrar {
        return new \WooCommerce\PayPalCommerce\Abilities\AbilitiesRegistrar();
    },
    /**
    ...
    'abilities.envelope-parser' => static function (ContainerInterface $container): EnvelopeParser {
        return new EnvelopeParser($container->get('abilities.logger'));
    },
    'abilities.handler.get-connection-status' => static function (ContainerInterface $container): GetConnectionStatusHandler {
        return new GetConnectionStatusHandler($container->get('settings.rest.common'), $container->get('abilities.envelope-parser'), $container->get('abilities.logger'));
    },
    'abilities.handler.get-payment-methods' => static function (ContainerInterface $container): GetPaymentMethodsHandler {
        return new GetPaymentMethodsHandler($container->get('settings.rest.payment'), $container->get('abilities.envelope-parser'), $container->get('abilities.logger'));
    },
    'abilities.handler.get-order-tracking' => static function (ContainerInterface $container): GetOrderTrackingHandler {
        return new GetOrderTrackingHandler($container->get('order-tracking.endpoint.controller'), $container->get('abilities.logger'));
    },
    'abilities.handler.get-paypal-order' => static function (ContainerInterface $container): GetPaypalOrderHandler {
        return new GetPaypalOrderHandler($container->get('api.endpoint.order.cached'), $container->get('abilities.logger'));
    },
);
