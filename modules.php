...
return static function (string $root_dir): iterable {
    ...
    $modules = array(new \WooCommerce\PayPalCommerce\PluginModule(), (require "{$modules_dir}/woocommerce-logging/module.php")(), (require "{$modules_dir}/ppcp-admin-notices/module.php")(), (require "{$modules_dir}/ppcp-api-client/module.php")(), (require "{$modules_dir}/ppcp-compat/module.php")(), (require "{$modules_dir}/ppcp-order-endpoints/module.php")(), (require "{$modules_dir}/ppcp-button/module.php")(), (require "{$modules_dir}/ppcp-session/module.php")(), (require "{$modules_dir}/ppcp-status-report/module.php")(), (require "{$modules_dir}/ppcp-wc-subscriptions/module.php")(), (require "{$modules_dir}/ppcp-wc-gateway/module.php")(), (require "{$modules_dir}/ppcp-webhooks/module.php")(), (require "{$modules_dir}/ppcp-wc-payment-tokens/module.php")(), (require "{$modules_dir}/ppcp-order-tracking/module.php")(), (require "{$modules_dir}/ppcp-uninstall/module.php")(), (require "{$modules_dir}/ppcp-blocks/module.php")(), (require "{$modules_dir}/ppcp-paypal-subscriptions/module.php")(), (require "{$modules_dir}/ppcp-local-alternative-payment-methods/module.php")(), (require "{$modules_dir}/ppcp-settings/module.php")(), (require "{$modules_dir}/ppcp-fraud-protection/module.php")(), (require "{$modules_dir}/ppcp-abilities/module.php")());
    ...
    if (apply_filters('woocommerce.feature-flags.woocommerce_paypal_payments.sdk_v6_enabled', getenv('PCP_SDK_V6_ENABLED') === '1' || 'yes' === get_option('woocommerce-ppcp-sdk-v6-eligible'))) {
